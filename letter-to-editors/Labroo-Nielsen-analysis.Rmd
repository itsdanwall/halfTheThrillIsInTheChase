...
of the `r reps` simulations `r (nlsn_escls_tbl2_reps_sum$psi_sim > nlsn_escls_tbl2_sum$psi_obs) %>% sum` had phis larger than the observed phi
...
of the `r reps` simulations `r (nlsn_shpro_tbl1_reps_sum$psi_sim > nlsn_shpro_tbl1_sum$psi_obs) %>% sum` were higher than the observed psi
